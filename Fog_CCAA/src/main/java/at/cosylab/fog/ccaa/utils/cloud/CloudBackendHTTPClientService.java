package at.cosylab.fog.ccaa.utils.cloud;
...
public class CloudBackendHTTPClientService {
    ...
    @Value("${cosylab.ccaa.tnta.url}")
    private String tntaURL;


    public void validateFTATicket(TicketSignature ticket) throws ConnectException, InternalServerErrorException {
