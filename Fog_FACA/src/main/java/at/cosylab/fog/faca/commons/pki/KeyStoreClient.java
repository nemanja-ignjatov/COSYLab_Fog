package at.cosylab.fog.faca.commons.pki;
...
public class KeyStoreClient {
    ...
    private final String tntaCertificateAlias = "facaCertificate";
    private final String tntaPrivateKeyAlias = "facaPrivateKey";
